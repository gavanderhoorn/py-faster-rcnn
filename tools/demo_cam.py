...
def vis_detections(im, class_name, dets, thresh=0.5):
	...
	for i in inds:
		...
		cv2.putText(image, class_name + " " + str(score), (bbox[0], bbox[1]), cv2.FONT_HERSHEY_PLAIN, 2.0, (255, 0, 0), 2)
		print "Found object."
...
if __name__ == '__main__':
	...
	# im_names = ['010000036.jpg', '020000157.jpg', '030000082.jpg',
	# 			'004545.jpg', 'box.png', 'box_rotated.png']
